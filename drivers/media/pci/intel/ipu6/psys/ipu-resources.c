...
#else
	hw_var.set_proc_dev_chn = ipu_fw_psys_set_proc_dev_chn;
	hw_var.set_proc_dfm_bitmap = ipu_fw_psys_set_proc_dfm_bitmap;
	hw_var.set_proc_ext_mem = ipu_fw_psys_set_process_ext_mem;
	hw_var.get_pgm_by_proc = ipu_fw_psys_get_pgm_by_process;
#endif
}
